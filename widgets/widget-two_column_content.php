...
/**
 * Adds Lfc_Two_Column_Content_Widget widget.
 */
class Lfc_Two_Column_Content_Widget extends WP_Widget {

    /**
     * Register widget with WordPress.
     */
    function __construct() {
        $widget_ops = array( 'classname' => 'lfc_two_column_content_widget', 'description' => __( 'A two-column text area.', 'lfc-two-column-content' ) );
        $control_ops = array( 'width' => 500, 'height' => 400 );
        parent::__construct( 'lfc-content-two-column-module', __( 'Two Column Content', 'lfc-two-column-content' ), $widget_ops, $control_ops );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        include( plugin_dir_path( __DIR__ ) . 'views/two_column_content.php' );
    }
    ...
    public function form( $instance ) {
        ...
        <div class="lfc-module-instructions">
            ...
            <div class="lfc-instructions-bd">
                The Two Column content panel allows you to add two evenly-sized columns of content, using a Visual editor to add text and images. 
            </div>
        </div>
